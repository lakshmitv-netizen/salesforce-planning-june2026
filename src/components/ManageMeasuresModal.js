...
export default function ManageMeasuresModal({ isOpen, onClose, measures: propMeasures, setMeasures: propSetMeasures }) {
  // Use measures from props, fallback to empty array
  const measures = propMeasures || [];
  const setMeasures = propSetMeasures || (() => {
    console.warn('setMeasures function not provided');
  });
  ...
  const handleSaveNewMeasure = () => {
    ...
    const newMeasure = {
      ...
      // Keep additional fields for ManageMeasuresModal compatibility
    ...
    // Add new measure to the top of the list
...
I'll intelligently assign the appropriate Source DMO based on your needs.`;
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className={`modal-container modal-measures ${(editPanelOpen || clonePanelOpen || deletePanelOpen || createPanelOpen || assignSubsetPanelOpen || aiChatOpen) ? 'with-panel' : ''}`} onClick={(e) => e.stopPropagation()}>
        {/* Modal Header */}
        ...
        <div className="modal-body-simple measures-content-wrapper">
          <div className="measures-main-content">
            ...
            <div className="measures-info">
              <p className="measures-title">Review Available Measures</p>
              <p className="measures-count">100+ Measures • 10+ Subsets</p>
            </div>
                    ...
                    >
                      <div className="subsets-display">
                        ...
                        {measure.subsets.length > 1 && (
                          <span className="subsets-more">
                            +{measure.subsets.length - 1} more
                          </span>
                        )}
                      </div>
                      {hoveredSubsetIndex === index && measure.subsets.length > 1 && (
                        <div className="subsets-popover">
                          ...
                          {measure.subsets.map((subset, idx) => (
                            <div key={idx} className="subsets-popover-item">
                              {subset}
                            </div>
                          ))}
                        </div>
        ...
        {editPanelOpen && selectedMeasure && (
          <div className="edit-panel">
            ...
            <div className="measure-tabs">
              ...
              <button 
                className={`measure-tab ${activeTab === 'subsets' ? 'measure-tab-active' : ''}`}
            ...
            <div className="edit-panel-header">
              ...
              <div className="edit-panel-header-actions">
                ...
                <button 
                  ...
                  onClick={handleSaveNewMeasure}
                  disabled={!newMeasureForm.name.trim()}
                  style={{ opacity: newMeasureForm.name.trim() ? 1 : 0.5 }}
                >
                  Save
                </button>
              </div>
                ...
                <>
                  ...
                  <div className="measure-section">
                    ...
                    <div className="edit-form-field">
                      ...
                      <input 
                        ...
                        onChange={(e) => setNewMeasureForm(prev => ({ ...prev, name: e.target.value }))}
                      />
                    </div>
                    ...
                    <div className="edit-form-field">
                      ...
                      <select 
                        ...
                        value={newMeasureForm.type}
                        onChange={(e) => setNewMeasureForm(prev => ({ ...prev, type: e.target.value }))}
                      >
                    ...
                    <div className="edit-form-field">
                      ...
                      <select 
                        className="edit-form-select" 
                        value={newMeasureForm.dataType}
                        onChange={(e) => setNewMeasureForm(prev => ({ ...prev, dataType: e.target.value, unit: e.target.value.toLowerCase() }))}
                      >
                  ...
                  <div className="measure-section">
                    ...
                    <div className="edit-form-field">
                      ...
                      <select 
                        className="edit-form-select" 
                        value={newMeasureForm.aggregation}
                        onChange={(e) => setNewMeasureForm(prev => ({ ...prev, aggregation: e.target.value }))}
                      >
        ...
        {assignSubsetPanelOpen && (
          <div className="edit-panel">
            <div className="edit-panel-header">
              ...
              <div className="edit-panel-header-actions">
                <button className="edit-panel-text-button edit-panel-cancel-button" onClick={closeAssignSubsetPanel}>
                  Cancel
                </button>
                <button 
                  className="edit-panel-text-button edit-panel-save-button" 
        ...
        <div className="modal-footer">
          <button 
            ...
            onClick={onClose}
            disabled={editPanelOpen || clonePanelOpen || deletePanelOpen || createPanelOpen || assignSubsetPanelOpen || aiChatOpen}
          >
            Done
          </button>
        </div>
