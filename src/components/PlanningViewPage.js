...
export default function PlanningViewPage({
  ...
  onNavigateToHierarchies,
  showConfigSavedToast,
  onCloseConfigSavedToast,
  planConfigs,
}) {
  ...
  // Use provided planConfigs or default to empty array
  const configs = planConfigs || [];

  const filteredPlanConfigs = configs.filter((config) => {
    ...
    <div className="measures-page-layout">
        ...
        <div className="planning-view-page">
          <div className="planning-view-header">
            <div className="planning-view-title-section">
              ...
              <p className="planning-view-subtitle">{configs.length} Configurations</p>
            </div>
      ...
      {showConfigSavedToast && (
        <Toast
          ...
          onClose={onCloseConfigSavedToast}
          duration={3000}
        />
      )}
    </div>
